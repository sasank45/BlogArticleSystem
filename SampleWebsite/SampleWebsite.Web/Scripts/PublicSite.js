var publicSiteApp = angular.module('publicSiteApp', ['ngRoute']);

publicSiteApp.config(['$routeProvider', function ($routeProvider) {
...
publicSiteApp.controller('ProductCtrl', ['$scope', '$http', function ($scope, $http) {
